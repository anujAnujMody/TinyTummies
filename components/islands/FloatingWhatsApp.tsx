      ...
      {visible && (
        ...
        >
          ...
          <AnimatePresence>
            {showTooltip && (
              <motion.div
                ...
                exit={{ opacity: 0, x: 10 }}
                className="bg-white rounded-xl shadow-lg px-4 py-2.5 mb-1 border border-tt-green/10"
              >
          ...
          <motion.a
            ...
            className="relative flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
